...
```bash
git clone https://github.com/spaceflight-ui/ui.git
```
...
This follows the registry schema at [https://ui.spaceflight.dev/schema/registry-item.json](https://ui.spaceflight.dev/schema/registry-item.json).
...
export const blocks = [
  ...
  {
    name: "dashboard-01",
    author: "spaceflight (https://ui.spaceflight.dev)",
    title: "Dashboard",
