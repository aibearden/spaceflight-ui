...
You can use any framework that supports React. [Next.js](https://ui.spaceflight.dev/docs/installation/next), [Astro](https://ui.spaceflight.dev/docs/installation/astro), [Remix](https://ui.spaceflight.dev/docs/installation/remix), [Gatsby](https://ui.spaceflight.dev/docs/installation/gatsby) etc.
