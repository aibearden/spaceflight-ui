...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/spaceflight/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/spaceflight/Projects/foobar/src/foo/bar")
  ...
  ).toEqual("/Users/spaceflight/Projects/foobar/src/components/foo/bar/baz")
  ...
  ).toEqual("/Users/spaceflight/Projects/foobar/src/app/components/foo/bar")
  ...
  ).toEqual("/Users/spaceflight/Projects/foobar/lib/utils")
})
